...
<div class=" m-1  p-3 rounded shadow border rounded-xl" style="background-color: aliceblue">
    ...
    <form action="{{ route('vehicles.store') }}" method="POST" enctype="multipart/form-data" class="max-w-md m-1 bg-white p-6 rounded shadow">
        @csrf
        @if ($errors->any())
