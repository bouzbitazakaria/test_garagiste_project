...
<div class="m-1 p-3 rounded-xl shadow bg-white border-radius-xl">
    <div class="d-flex align-items-center mb-2"> 
        <a href="{{route('vehicles.index')}}" class="me-2">
            <div class="icon icon-shape icon-md text-center d-flex align-items-center justify-content-center p-2 m-2">
    ...
    <form action="{{ route('profil.update', $client->id) }}" method="POST" class="max-w-md mx-2 p-4 ">
        @csrf
        @method('PUT')
