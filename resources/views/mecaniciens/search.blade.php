...
<script>
  document.getElementById('searchInput').addEventListener('input', function() {
      ...
      axios.get(`/api/mecaniciens/search?query=${query}`)
          .then(response => {
              const mecaniciens = response.data;
              let html = '';
                ...
                mecaniciens.forEach(mecanicien => {
                      html += `
                          <tr>
                              ...
                              <td class="align-middle text-center">
                                  <span class="text-secondary text-xs font-weight-bold">${mecanicien.salary}</span>
                              </td>
                              <td class="align-middle text-center">
                  ...
                  html = `
                      <tr>
                          <td colspan="5" class="text-center">No Mechanic found</td>
                      </tr>`;
              }
